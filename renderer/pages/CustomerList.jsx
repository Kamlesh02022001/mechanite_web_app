            ...
            <div className="flex">
                ...
                <div className="w-full h-screen bg-[#f7f5f5] overflow-y-auto">
                    ...
                    <div className="flex items-center flex-col px-5 pb-10">
                        <h1 className="text-4xl font-bold text-[#7d40ff] mt-5">Customer List</h1>
                                    ...
                                    >
                                        <div className="flex flex-col gap-3">
                                            <p>
                                                ...
                                                {customer.customer_name || 'No Description Available'}
                                            </p>
                                            <p>
                                                <strong className="text-gray-800 font-bold">Email:</strong>{' '}
                                                {customer.email || 'No Description Available'}
                                            </p>
                                            <p>
                                                <strong className="text-gray-800 font-bold">Customer ID:</strong>{' '}
                                                {customer.customer_id || 'No Description Available'}
                                            </p>
                                        </div>
